  ...
  <tbody>
    <?php 
      foreach ($ids as $key => $value) 
      {
        ...
        //设置选项
        echo "<td><select name=\"{$value['ID']}\" class=\"form-control input-sm\">
        ...
        //设置按钮
        echo "<td><button class=\"btn btn-default btn-sm\" id=\"{$value['ID']}\" type=\"button\">".$this->lang->line('button_save')."</button></td>";
        echo "</tr>";
      }
    ?>  
  </tbody>
