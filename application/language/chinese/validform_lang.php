...
/* 参数配置 */	
	...
	$lang['validform_voltage_triptime_fast'] = "请输入0-1之间的小数(精确到小数点后两位)";//外围过欠压延迟保护时间
	$lang['validform_voltage_triptime_slow'] = "请输入0-99之间的小数(精确到小数点后两位)";//内围过欠压延迟保护时间
	$lang['validform_frequency_triptime_fast'] = "请输入0-1之间的小数(精确到小数点后两位)";//外围过欠频延迟保护时间
